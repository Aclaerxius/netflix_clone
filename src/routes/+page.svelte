...
<section>
	<div class="relative bg-local bg-center bg-cover bg-no-repeat w-full h-svh"
		style = "background-image: url(https://img.daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg); ">

	</div>
	
	<div class="w-full absolute top-0 left-0 text-left ml-10 align-middle">
		
		
		<h1 class="text-5xl font-bold">Title</h1>
		<p class="mb-5">Info</p>
		<button class="btn btn-sm text-black bg-white hover:bg-slate-200 hover:text-black"
		>► Play</button
		>
		
	</div>
	<div class="absolute bg-gradient-to-r from-black to-transparent opacity-80"></div>
